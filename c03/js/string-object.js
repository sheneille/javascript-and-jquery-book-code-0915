...
var msg = '<h2>length</h2><p>' + saying.length + '</p>'
// Convert the string to uppercase and add it to the msg

msg += '<h2>uppercase</h2><p>' + saying.toUpperCase() + '</p>';

// Convert the string to lowercase and add it to the msg

msg += '<h2>lowercase</h2><p>' + saying.toLowerCase() + '</p>';

// Find the character with an index of 12 in the string and add it to the msg variabl
